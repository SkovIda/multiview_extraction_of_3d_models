...
# SOURCE OF THIS FILE (colmap2poses.py): https://github.com/Sazoji/nvdiffrec/blob/main/colmap2poses.py
...
# TODO: Apply changes to colmap2poses.py file as suggessted in comment by mexicantexan on Jun 24, 2022: https://github.com/NVlabs/nvdiffrec/issues/3
# to use own masks with colmap2poses.py insead of using rembg to generate masks.
